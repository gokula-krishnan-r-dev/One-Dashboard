...
const ChatMessage = () => {
  return (
    <React.Fragment>
      <div className="bg-[#FAFAFA] w-full flex relative font-play h-[calc(100vh-80px)] mt-20">
        <div className="lg:w-[50%] md:w-2/5 xl:w-[40%] w-full bg-white border-r">
          <div className="flex items-center justify-between">
            <h4 className="text-3xl p-4">Messages</h4>
            <AiOutlineMore />
          </div>
          <div className="px-4 py-2">
            <div className="relative text-gray-600 focus-within:text-gray-400 w-full">
              ...
              <input
                type="search"
                name="q"
                className="w-full py-3 border text-sm text-white pl-10 focus:outline-none focus:bg-white focus:text-gray-900"
                placeholder="Search..."
                autoComplete="off"
              />
            </div>
            <div className="w-full flex space-x-2 pt-4 bg-gray-50 p-1 mt-2 relative sm:border-none border-b">
              ...
              <div className="w-full">
                ...
                <p className="text-[12px] truncate w-36 text-gray-400">
        ...
        <div className="lg:w-5/6 md:w-3/5 md:block hidden bg-white relative">
          ...
          <div className="w-full">
            <div>
              <p className="text-gray-400 text-center text-[12px] py-2">
                Today
              </p>
              <div className="py-2 px-8 flex justify-end">
                <p className="bg-gray-100 p-2 rounded-b-lg font-light text-sm max-w-md">
              ...
              <div className="text-[11px] text-gray-400 flex items-center justify-end  px-8">
          ...
          <div className="w-full">
            <div>
              <div className="py-2 px-8 flex justify-start">
                <p className="bg-blue-500 p-2.5 text-white rounded-b-lg font-light text-sm max-w-md">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit
                </p>
              </div>
              <div className="text-[11px] text-gray-400 flex items-center justify-start  px-8">
                10.12 AM{" "}
              </div>
            </div>
          </div>
          <div className="w-full absolute bottom-0">
            <form>
              ...
              <div className="flex items-center py-2 px-3 bg-gray-50 rounded-lg relative">
                <div className="flex px-2 py-2 space-x-4 absolute right-20 bg-gray-50 rounded-lg">
                ...
                <textarea
                  id="chat"
                  rows="2"
                  className="block mx-4 p-2.5 outline-none w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300"
