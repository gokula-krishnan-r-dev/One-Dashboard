    ...
    return (
        <div className="text-white text-gray-400 p-2 font-play">
            ...
            <div className="flex space-x-2 items-center py-4">
                ...
                <div className=" bg-gray-200 flex items-center space-x-2 p-2">
                    <GrDocumentZip size={24} className="text-white bg-blue-500" />
                    <div className="block">
            ...
            <div className="flex space-x-2">
                ...
                <p className="text-gray-400">The information I provided is accurate and clear. Any changes at this point require approval and may cost extra.</p>
            </div>
        </div>
    )
}
