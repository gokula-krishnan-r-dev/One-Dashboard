    ...
    <div className="text-white SmoothAnimation smooth-tras text-gray-400 p-2 font-play">
      <div className="flex space-x-24 py-3">
        <div className="block py-2 font-normal">
          <p className="text-[#131313] text-sm py-1 ">Created</p>
          <p className="text-[#131313] text-sm py-1">July 20, 2021</p>
          <p className="text-[#131313] text-sm py-1">Reference Links</p>
          <p className="text-[#131313] text-sm py-1">Description</p>
        </div>
        <div className="block py-2 font-semibold text-base">
          <p className="text-[#131313] text-[16px] text--font font-[600] py-1">
            July 20, 2021
          </p>
          <p className="text-[#131313] text-[16px] text--font font-[600] py-1">
            3D Animation
      ...
      <p className="text-base font-[400] text--font  text-black py-1">
      ...
      <div className="flex space-x-2">
        ...
        <p className="text-[#13131380] text-base font-medium">
