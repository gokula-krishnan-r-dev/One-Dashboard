...
const CardProject = (props) => {
    const { product } = props
    return (
        <div className="2xl:w-[392px] xl:w-[320px] md:w-[530px] w-[350px] p-2 bg-white font-play">
            ...
            <div className="flex space-x-4 justify-between items-center py-2">
                ...
                {/*<Link href={'/'+ product.id} key={product.id}>*/}
                 <li className="block w-1/3 bg-[#007AFF] mt-4 py-2 text-white font-semibold mb-2 text-center"><Link href={'client/'+ product.id} key={product.id}>View</Link></li>
                {/*</Link>*/}
            </div>
        </div>
    )
