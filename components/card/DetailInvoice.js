      ...
      <div className="text-white text-gray-400 p-2 font-play">
        <div className="md:flex md:justify-between block">
          <div className="md:py-2 w-full">
            <h4 className="text-lg font-bold text-[#007AFF]">
              3D Content Studio
            </h4>
          ...
          <div className="md:block font-bold w-full">
            <h3 className="text-2xl text-blue-600 md:text-right py-1">
              Invoice
            </h3>
            <h3 className="text-2xl items-end flex justify-end text-blue-600">
              #OD170720201002
            </h3>
          </div>
        </div>
        ...
        <div className="block mb-2">
          ...
          <div className="flex justify-between">
            <p className="text-[#131313] font-normal text-base w-40 font-play">
