  ...
  return (
    <>
      <div className="h-screen md:flex">
        <div className="flex flex-col lg:w-[35%] w-full py-10 items-center bg-white">
          <div className="w-10/12 font-play">
            ...
            <form className="bg-teal-white" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="py-2 md:space-x-4 md:flex md:justify-between">
                <div className="w-full relative">
                  ...
                  <div className="relative">
                    ...
                    />
                    {errors.firstName && (
                      <p className="absolute -bottom-1 text-red-500 text-[12px]">
              ...
              <div className="md:py-2 py-0 relative mb-2">
                ...
                {errors.email && (
                  <p className="absolute -bottom-3 text-red-500 text-[12px]">
              ...
              <div className="mt-6">
                <button className="block w-full bg-[#007AFF] mt-4 py-3 text-white mb-2">
                  Sign Up
                </button>
                <button
                  type="submit"
